...
class ProductManager {
    ...
    this.products = [
      {
        ...
        description:
          'Soft matte, longwear foundation with medium to full buildable coverage.',
        ...
        retailers: [
          {
            name: 'Sephora',
            url: 'https://example.com/sephora-fenty',
            price: 40,
          },
          { name: 'Ulta', url: 'https://example.com/ulta-fenty', price: 42 },
          {
            name: 'Amazon',
            url: 'https://example.com/amazon-fenty',
            price: 39,
          },
        ],
      },
      {
        ...
        description:
          'Weightless, long-lasting liquid blush that blends effortlessly.',
        ...
        retailers: [
          {
            name: 'Sephora',
            url: 'https://example.com/sephora-rare',
            price: 20,
          },
      ...
      },
      {
        ...
        retailers: [
          {
            name: 'Glossier',
            url: 'https://example.com/glossier-direct',
            price: 22,
          },
          {
            name: 'Sephora',
            url: 'https://example.com/sephora-glossier',
            price: 24,
          },
          {
            name: 'Amazon',
            url: 'https://example.com/amazon-glossier',
            price: 21,
          },
        ],
      },
      {
        ...
        description:
          'Potent vitamin C day serum that firms, brightens, and improves signs of photoaging.',
      ...
      },
      {
        ...
        currency: 'USD',
        image:
          'https://images.unsplash.com/photo-1586495985854-1ae265eddbb4?w=400&h=400&fit=crop',
        description:
          'Matte Revolution lipstick in the universally flattering Pillow Talk shade.',
        affiliateUrl:
          'https://example.com/affiliate/charlotte-tilbury-lipstick',
        retailer: 'Ulta',
        onSale: false,
        trending: true,
        rating: 4.8,
      ...
      },
      {
        ...
        retailers: [
          ...
          {
            name: 'Sephora',
            url: 'https://example.com/sephora-ordinary',
            price: 8,
          },
          {
            name: 'Amazon',
            url: 'https://example.com/amazon-ordinary',
            price: 6,
          },
        ],
      },
      {
        ...
        description:
          'At-home treatment that reduces breakage and strengthens all hair types.',
        ...
        retailers: [
          {
            name: 'Sephora',
            url: 'https://example.com/sephora-olaplex',
            price: 30,
          },
          { name: 'Ulta', url: 'https://example.com/ulta-olaplex', price: 32 },
          {
            name: 'Amazon',
            url: 'https://example.com/amazon-olaplex',
            price: 29,
          },
        ],
      },
      {
        ...
        image:
          'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=400&h=400&fit=crop',
        description:
          'Fast drying with no extreme heat to help protect hair from damage.',
        ...
        retailers: [
          ...
          {
            name: 'Sephora',
            url: 'https://example.com/sephora-dyson',
            price: 430,
          },
          {
            name: 'Amazon',
            url: 'https://example.com/amazon-dyson',
            price: 425,
          },
        ],
      },
      {
        ...
        description:
          'Oil-free pore-refining water cream that delivers pure hydration.',
        ...
        retailers: [
          {
            name: 'Sephora',
            url: 'https://example.com/sephora-tatcha',
            price: 68,
          },
          { name: 'Ulta', url: 'https://example.com/ulta-tatcha', price: 70 },
          {
            name: 'Amazon',
            url: 'https://example.com/amazon-tatcha',
            price: 67,
          },
        ],
      },
      {
        ...
        image:
          'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=400&h=400&fit=crop',
        description:
          'Makeup setting spray that keeps makeup fresh for up to 16 hours.',
      ...
      },
      {
        ...
        image:
          'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=400&fit=crop',
        description:
          'Serum-highlighter hybrid with niacinamide for a dewy glow.',
        ...
        retailers: [
          {
            name: 'Sephora',
            url: 'https://example.com/sephora-glow',
            price: 34,
          },
      ...
      },
      {
        ...
        image:
          'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=400&h=400&fit=crop',
        description:
          'The original award-winning makeup sponge for flawless application.',
  ...
  static async addProductByUrl(url) {
    ...
    if (!isSupported) {
      throw new Error(
        'Retailer not supported. Supported retailers: ' +
    ...
    return {
      status: 'pending',
      message:
        'Product submitted for review. It will appear in the catalog once approved.',
